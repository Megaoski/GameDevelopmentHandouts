...
void j1Map::PropagateBFS()
{
	...
	if (frontier.Count() > 0)
	{
		...
		iPoint ref1; //right neighbour
		iPoint ref2; //left neighbour
		iPoint ref3; //top neighbour
		iPoint ref4; //bottom neighbour
		...
		if (visited.find(ref1) == -1 && IsWalkable(ref1.x, ref1.y) == true)
		{
		...
		if (visited.find(ref2) == -1 && IsWalkable(ref2.x, ref2.y) == true)
		{
		...
		if (visited.find(ref3) == -1 && IsWalkable(ref3.x, ref3.y) == true)
		{
		...
		if (visited.find(ref4) == -1 && IsWalkable(ref4.x, ref4.y) == true)
		{
